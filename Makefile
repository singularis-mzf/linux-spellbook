...
OBRAZKY_IK += make.png manuálové-stránky.png markdown.png nabídka-aplikací.png odkazy.png perl-moduly.png perl-základy.png
OBRAZKY_IK += plánování-úloh.png práce-s-archivy.png proměnné.png regulární-výrazy.png
