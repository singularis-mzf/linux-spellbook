...
# N, O, P, Q, R, S
VSECHNY_KAPITOLY += nabídka-aplikací odkazy pdf perl-objekty perl-standardní-knihovna perl-základy plánování-úloh práce-s-archivy proměnné regulární-výrazy
# S
