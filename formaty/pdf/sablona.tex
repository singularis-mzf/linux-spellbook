...
\usepackage[dvipdfm,a4paper,inner=1.5cm,outer=1cm,top=1.5cm,bottom=1.5cm]{geometry} % + showframe pro ladění
{{KONEC POKUD}}
{{POKUD JE FORMÁT pdf-a5}}
\usepackage[dvipdfm,a5paper,inner=1.5cm,outer=1cm,top=1.5cm,bottom=1.5cm]{geometry} % + showframe pro ladění
{{KONEC POKUD}}
...
\usepackage{xcolor}         % barevné písmo
