...
\newenvironment{odstavce}{\begin{adjustwidth}{1.0cm}{1.0cm}}{\end{adjustwidth}}
...
\newcommand{\zaklinadlo}[5][]{{%
    ...
    \newcommand*{\radekzaklinadla}[1]{%
        ...
        % Vypsat samotný řádek zaklínadla:
        {##1}%
    }%
...
\noindent\begin{tabular}{|l|p{0.6\textwidth}|}%
...
{\textcolor{seda}{\ensuremath{\dlsh}}}&%
    ...
    je každá z nich ukončena šedým symbolem odrádkování; není-li na konci řádku tento symbol,
