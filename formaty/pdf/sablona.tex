...
\usepackage[IL2,TU]{fontenc}
\usepackage{fontspec}
%
{{POKUD JE FORMÁT pdf-a4}}
\usepackage[xetex,a4paper,inner=2.5cm,outer=2cm,top=1.5cm,bottom=2cm]{geometry} % + showframe pro ladění
...
% Poznámka − balíček {gensymb} nefunguje správně v XeLaTeXu; odvolává se na kódování fontů TS1
...
\newfontfamily{\zaklinadlofamily}[Scale=MatchLowercase]{Latin Modern Mono Light}
...
\newcommand*{\dopln}[1]{{\doplnfamily\mdseries\itshape\underline{{#1}}}}%
\newcommand*{\moznyzlom}{{\mdseries\upshape\textcolor{seda}{\-}}}%
\newcommand{\nepoprve}[1]{#1}
\newcommand*{\tritecky}{{\sffamily\mdseries\upshape\normalsize\mbox{...}}}%
% {} \big \Big \bigg \Bigg
...
\newcommand*{\reseninezname}{{\bfseries\color{seda}?}}
...
\newcommand{\zaklinadlo}[5][]{{%
    ...
    \newcommand*{\radekzaklinadla}[1]{%
        ...
        \nepoprve{{%
            \fontencoding{IL2}\fontfamily{bsk}\fontseries{m}\fontshape{n}\selectfont\color{seda}\ensuremath{\carriagereturn}%
            \\\relax%
        }}%
    ...
    \parbox{\textwidth}{\raggedright%
        ...
        \dashbox{\color{black}\parbox{\sirkakodu}{\raggedright%
            \zaklinadlofamily\mdseries\upshape\budepoprve%
            #5%
        }}%
