...
\usepackage[xetex,a4paper,inner=2.5cm,outer=2cm,top=1.5cm,bottom=2cm]{geometry}
...
% {fontspec}:
    ...
    \newfontfamily{\enterfamily}{DejaVu Sans Mono} % speciálně kvůli symbolu šipky č. 8626
...
% {titlesec}:
    ...
    \titleformat{\chapter}[hang]{\normalfont\LARGE\bfseries}%
        {\settowidthwithminimum{\sirkastitkutmp}{\mbox{\thechapter}}{20pt}\makebox[\sirkastitkutmp][l]{\thechapter}}%
        {0.33em}{}\relax
    \titlespacing*{\chapter}{0pt}{-1ex}{2ex plus2ex minus0.5ex}\relax

    \titleformat{\section}[hang]{\normalfont\Large\bfseries}%
        {\settowidthwithminimum{\sirkastitkutmp}{\mbox{\thesection}}{20pt}\makebox[\sirkastitkutmp][l]{\thesection}}%
        {0.33em}{}\relax
...
\newcommand*{\konecradku}{{\normalfont\enterfamily\color{seda}↲}}% \u21b2 = 8626
...
\newcommand*{\stitek}[1]{{%
    \settowidthwithminimum{\sirkastitkutmp}{#1}{\minsirkastitku}%
    \mbox{\tcbox[boxrule=0.5pt,size=fbox,arc=1mm]{\makebox[\sirkastitkutmp]{\rule[-0.45ex]{0pt}{1em}#1}}}%
}}

\newcommand*{\stitekrejstriku}[1]{{%
    \settowidthwithminimum{\sirkastitkutmp}{#1}{\minsirkastitku}%
    \mbox{\tcbox[boxrule=0.5pt,size=fbox,arc=1mm,boxsep=2pt,left=1pt,right=1pt]{\makebox[\sirkastitkutmp][l]{\rule[-0.45ex]{0pt}{1em}#1}}}%
}}
...
\newcommand{\zaklinadlo}[5][]{{%
    ...
    \newcommand*{\radekzaklinadla}[1]{%
        ...
        \nepoprve{\konecradku\\\relax}%
        % Vypsat samotný řádek zaklínadla (nutný „strut“ kvůli výšce řádku a orámování):
        {\rule{0pt}{1.5ex}##1}%
    }%
    \newcommand*{\akcezaklinadla}[1]{\radekzaklinadla{\ensuremath{\Rightarrow}~\rmfamily\itshape{}##1}}%
    \newcommand*{\radekzaklinadladopreambule}[1]{\radekzaklinadla{\makebox[0pt][r]{\dozahlavi\hspace*{0.25em}}##1}}%
    %
    ...
    \parbox{\textwidth}{\raggedright%
        ...
        \dashbox{\color{black}\parbox{\sirkakodu}{\raggedright%
            \normalfont\zaklinadlofamily\budepoprve%
            #5%
        }}%
