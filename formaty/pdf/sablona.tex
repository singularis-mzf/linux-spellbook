...
\usepackage[xetex,b5paper,inner=2cm,outer=1.5cm,top=1.5cm,bottom=2cm]{geometry}
{{KONEC POKUD}}
{{POKUD JE FORMÁT pdf-a5}}
\usepackage[xetex,a5paper,inner=1.5cm,outer=1cm,top=1.5cm,bottom=1.5cm]{geometry}
{{KONEC POKUD}}
...
%
{{POKUD JE FORMÁT pdf-a5}}
\setlength{\sirkakodu}{0.98\textwidth}
...
\newenvironment*{odrazky}{%
    \begin{itemize}[rightmargin=\omezeniodstavce]\renewcommand*{\baselinestretch}{1.2}\selectfont%
}{%
    \end{itemize}%
}
