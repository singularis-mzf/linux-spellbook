...
\newenvironment*{priklad}[3][]{%
    ...
    \newcommand*{\akceprikladu}[1]{%
        \nepoprve{{%
            \fontfamily{bsk}\fontseries{m}\fontshape{n}\selectfont%
            \textcolor{seda}{\ensuremath{\carriagereturn}}%
        }}%
        \item\ensuremath{\Rightarrow}~{\rmfamily{}##1}%
    }%
    \begin{samepage}
...
% \blankspacedot
%\newlength{\blankspacedotwidth}
%\newcommand*{\blankspacedot}{{%
%    \settowidth{\blankspacedotwidth}{.}%
%    \makebox[\blankspacedotwidth]{{%
%        \bfseries\color{seda}\ensuremath{\cdot}%
%    }}%
%}}
