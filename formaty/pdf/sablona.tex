...
\newcommand*{\inicializovatnastaveni}{%
    \newlength{\sirkakodu}\setlength{\sirkakodu}{0.9\textwidth} % šířka kódu v příkladech (obvykle odvozena od šířky textu „\textwidth“)
    ...
    \newcommand*{\zapnoutrezimlicence}{%
        \begin{multicols*}{2}%
            ...
            \tiny%
            \renewenvironment*{odstavce}{\begin{adjustwidth}{}{}}{\end{adjustwidth}}}
...
\usepackage[xetex,b5paper,inner=2cm,outer=1.5cm,top=1.5cm,bottom=2cm]{geometry} % + showframe pro ladění
\newcommand{\inicializovatnastaveni}{%
...
\usepackage[xetex,a5paper,inner=1.5cm,outer=1cm,top=1.5cm,bottom=1.5cm]{geometry} % + showframe pro ladění
\newcommand{\inicializovatnastaveni}{%
...
\usepackage{ifthen}         % příkaz \ifthenelse a související konstrukce [ ] nahradit modernější alternativou
...
\newlength{\odsazeni}\setlength{\odsazeni}{2em}
\newlength{\minsirkastitku}\setlength{\minsirkastitku}{2cm}
\newlength{\sirkaikony}\setlength{\sirkaikony}{10pt}
\newlength{\sirkacislazaklinadla}\setlength{\sirkacislazaklinadla}{23pt}
\newlength{\zaklinadlotabcolsep}\setlength{\zaklinadlotabcolsep}{3pt}
...
\newcommand*{\kapitola}[2][]{\ifthenelse{\equal{#1}{}}{\chapter{#2}}{\chapter[#1]{#2}}}
...
\newenvironment*{odsazenyodstavec}[1]{%
    \vspace{1ex}\begin{adjustwidth}{#1\odsazeni}{#1\odsazeni}%
}{%
    \end{adjustwidth}%
    \vspace{1ex}%
}%
\newcommand*{\priklad}{\rmfamily\qquad{\lmmathfamily{}⊨}\quad}
...
\newcommand{\zaklinadlo}[5][]{{%
    ...
    \newcommand*{\akcezaklinadla}[1]{\radekzaklinadla{\ensuremath{\Rightarrow}}{##1}}%
    \newcommand*{\radekzaklinadladopreambule}[1]{\radekzaklinadla{\dozahlavi}{##1}}%
...
\newcommand{\ukazka}[2][]{{%
    \setlength{\tabcolsep}{\zaklinadlotabcolsep}%
    \setlength{\sirkaradkuzaklinadla}{\textwidth}%
...
{\zaklinadlofamily ABC=\,{\fontfamily{qcr}\fontseries{m}\fontshape{n}\selectfont\color{seda}\char`\\}}&%
