...
{{POKUD NENÍ FORMÁT pdf-a4-bez|pdf-b5-bez}}
        ...
        \begin{tcolorbox}[size=minimal,width=1cm,height=14mm,halign=center,valign=bottom,colback=cerna,top=1mm,bottom=1mm,left=0pt,right=0pt]%
            \ifnumodd{\value{page}}{\color{bila}\sffamily\mbox{#2}}{\mbox{}}%
        \end{tcolorbox}%
        }}%
{{KONEC POKUD}}
    }%
...
% {titlesec}:
    ...
    \titleformat{\chapter}[hang]{%
        ...
        %\includegraphics[width=2em,height=2em]{../../obrazky/ik/awk.png}
    ...
    \titleformat{\subsection}[hang]{\normalfont\fontsz{11pt}}%
        {}%
        {0pt}{%
            $^{\mbox{{\small s\arabic{section}/}}}$\arabic{subsection}
        }\relax
...
\newcommand*{\klavesa}[1]{%
    \tcbox[size=fbox,on line,leftrule=0.4pt,toprule=0.4pt,rightrule=1.5pt,bottomrule=1.5pt,boxsep=1.5pt,left=1.5pt,right=1.5pt]{%
        {\sffamily\raisebox{0ex}[1.4ex][0.2ex]{{%
            #1%
    }}}}}%
...
\newcommand*{\ikonazaklinadla}[1]{{%
    \raisebox{-0.25em}{\begin{tcolorbox}[width=1.25em,height=1.25em,halign=center,valign=center,circular arc,boxsep=0pt,left=0pt,right=0pt,top=0pt,bottom=0pt,boxrule=0.5pt,colback=svetleseda,standard jigsaw,opacityback=0]\makebox[0pt]{#1}\end{tcolorbox}}%
    \rule{0.2em}{0pt}%
}}
...
\begin{blok}%
    ...
    \begin{picture}(2,1.4)%
        ...
        \put(1.25,-0.1){\includegraphics[width=0.25\textwidth]{../pdf-spolecne/qr.eps}}
    \end{picture}%
\end{blok}%
\par\vfill%
%
