...
* Sbírat a sdílet co nejužitečnější přehled možností, které nabízí uživatelům svobodný software v operačních systémech založených na distribuci Debian a jádru Linux.
...
* Linux: Kniha kouzel je zaměřena na svobodný software. Nesvobodný software může být zmíněn a případně i doporučen (pokud svobodná alternativa neexistuje nebo není vhodná), v každém takovém případě ale musí být uvedeno upozornění, že uvedený software není svobodný. Toto upozornění může být uvedeno i v poznámce pod čarou, a pokud je nesvobodný software zmíněn v textu hypertextového odkazu nebo tlačítka, stačí, když bude upozornění uvedeno na odkazované stránce.
...
* **výstižná česká terminologie** — Vanilková příchuť Linuxu: Knihy kouzel usiluje o nalezení a používání výstižných českých termínů, a to i tehdy, kdy nejsou široce používané (např. „odzvláštnění“). Pokud však takový termín není znám, vanilková příchuť upřednostňuje výstižnější anglický termín před nevkusným překladem.
* **genderová spravedlnost** — V každé kapitole musí být přibližně vyrovnaný počet použití slov „řádka“ a „řádek“. Cílem tohoto opatření je napomoci gendrové spravedlnosti v jazyce. Naopak přechylování označení osob se doporučuje se vyhýbat, píšeme „uživatel“, ne „uživatelka“. Čtenáři vykáme a oslovujeme ji/ho v druhé osobě jednotného čísla, a kde je to možné, uvádíme obě rodové varianty oddělené lomítkem, ne však v podstatných jménech. (Výjimka platí pro předmluvu, kde uvádím u podstatných jmen označujících osoby přechýlenou i nepřechýlenou variantu, protože se příliš bojím „idiotů“, které by mohlo urazit, kdyby v předmluvě nebyli osloveni „čtenářko“; nejsem si jistý/á existencí těchto idiotů, jen mám strach, že kvůli takové hlouposti na Linux: Knihu kouzel zanevřou.)
...
* V sekci „Instalace na Ubuntu“ a případně v poznámkách pod čarou nebo v kódu zaklínadel musejí být zmíněny všechny balíčky, které může být nutné doinstalovat, a všechny změny nastavení, které je třeba provést, aby byla zaklínadla v kapitole použitelná. Pokud proces instalace vyžaduje interakci s uživatelem, musí být popsána „algoritmicky“ a nevyžadovat od uživatele žádné specifické znalosti (nanejvýš ty zmíněné v úvodu kapitoly).
