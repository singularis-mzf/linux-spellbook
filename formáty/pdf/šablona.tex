...
%
% \zaklinadlo[#1=(rezervováno)]{#2=číslo zaklínadla}{#3=\hline?}{#4=titulek + \footnotemark}{#5=\footnotetext...}{#6=řádky a akce zaklínadla}
% ====================================
\newcommand{\zaklinadlo}[6][]{{%
    ...
    \newcommand*{\zacatek}[1]{%
        ...
        \noindent\hspace*{2pt}\hspace*{\sirkaikony}\begin{tabular}{%
